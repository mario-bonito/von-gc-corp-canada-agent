...
with CorporationsCanada() as corporationscanada:
    ...
    for corp_type in CORP_TYPES_IN_SCOPE:
        ...
        sql = """
                select corp_num
                from corporationscanada.corporation
                where corp_typ_cd = '""" + corp_type + """'
                order by corp_num desc
               """
        corps = corporationscanada.get_corpscanada_sql("corps_by_type", sql, cache=False)
    ...
    with EventProcessor() as event_processor:
        ...
        #max_event_date = corporationscanada.get_event_id_date(max_event_id)
