...
from corpscanada.corpscanada_pipelines import corpscanada_pipeline_load_active
...
parent_pipeline = Pipeline(
    ...
    description = 'Holder for the different versions of the Corportaions Canada pipeline.')

parent_pipeline.add(corpscanada_pipeline_load_active())
